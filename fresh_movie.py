...
<head>
    ...
    <meta charset="utf-8">
<<<<<<< HEAD
    <title>First Udacity project</title>
||||||| merged common ancestors
    <title>Fresh Tomatoes!</title>
=======
    <title>Movie trailers!</title>
>>>>>>> e3f362e380a66bf4309dabe1798a686b52c0dafb
...
def tv_movies_page(tvs):
  # Create or overwrite the output file
  output_file = open('Tv_shows.html', 'w')

  # Replace the placeholder for the movie tiles with the actual dynamically generated content
  rendered_content = main_page_content.format(movie_tiles=create_movie_tiles_content(tvs))
